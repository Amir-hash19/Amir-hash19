...
INFO = [
    ("__header__", "Amirhosein Heidari", ""),
    ("__rule__", "", ""),

    ("Role",  "Backend Developer · Junior DevOps Engineer", "val"),
    ("Focus", "Backend Systems · System Design · Architecture Design", "accent"),

    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),

    ("Lang",    "Python · Bash", "val"),
    ("Backend", "FastAPI · Django · Django REST Framework", "val"),
    ("AI",      "RAG · LangChain", "val"),
    ("DevOps",  "Docker · Kubernetes · Nginx · Linux · GitHub Actions", "val"),
    ...
    ("In",   "linkedin.com/in/amirykta2002", "accent"),
    ("Mail", "amirhosein.hydri1381@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    # command line
    parts.append(
        f'<text x="{CMD_X}" y="66" class="row" style="animation-delay:.05s">'
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">neofetch --profile</tspan>'
        f'</text>'
    )
    ...
    fy = H - 24
    parts.append(
        f'<text x="{CMD_X}" y="{fy}" class="row" style="animation-delay:{delay+0.1:.2f}s">'
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">Open to Backend / DevOps opportunities</tspan>'
